...
function Result(value, messages) {
    ...
    if (value instanceof Result){
        ...
        this.messages = combineMessages(this, value);
    } else {
        this.value = value;
    }
}
...
Result.prototype.flatMapThen1 = function(func) {
    var that = this;
...
Result.prototype.smartMap = function(func) {
    var that = this;
    // eslint-disable-next-line no-undef
    return Promise.resolve(func(this.value)).then(function(otherResult) {
        if (otherResult instanceof Result){
            return new Result(otherResult.value, combineMessages([that, otherResult]));
        } else {
            return new Result(otherResult, this.messages);
        }
    });
};
